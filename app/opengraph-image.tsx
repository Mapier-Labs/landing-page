...
export default function OGImage() {
  return new ImageResponse(
    ...
    >
      ...
      <img
        alt=""
        src={`${process.env.NEXT_PUBLIC_BASE_URL || ""}/landing/stickers/Frame 3185590.png`}
        style={{
          position: "absolute",
          top: "40px",
          left: "60px",
      ...
      <img
        alt=""
        src={`${process.env.NEXT_PUBLIC_BASE_URL || ""}/landing/stickers/Group 2628.png`}
        style={{
          position: "absolute",
          top: "80px",
          right: "80px",
      ...
      <img
        alt=""
        src={`${process.env.NEXT_PUBLIC_BASE_URL || ""}/landing/stickers/Group 2619.png`}
        style={{
          position: "absolute",
          bottom: "60px",
          left: "100px",
      ...
      <img
        alt=""
        src={`${process.env.NEXT_PUBLIC_BASE_URL || ""}/landing/stickers/Group 2620.png`}
        style={{
          position: "absolute",
          bottom: "80px",
          right: "60px",
      ...
      <img
        alt=""
        src={`${process.env.NEXT_PUBLIC_BASE_URL || ""}/landing/stickers/Group 2627.png`}
        style={{
          position: "absolute",
          top: "50%",
          left: "40px",
      ...
      <img
        alt=""
        src={`${process.env.NEXT_PUBLIC_BASE_URL || ""}/landing/stickers/Group 2626.png`}
        style={{
          position: "absolute",
          bottom: "40%",
          right: "50px",
