        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Mapier is a next-generation navigation application that combines the power of Large Language Models with comprehensive mapping technology. Our platform understands natural language queries, learns from user behavior, and provides intelligent, personalized navigation experiences.
            </p>
            <p className="text-gray-600 leading-relaxed mb-6">
              Unlike traditional navigation apps, Mapier doesn't just find locations—it understands context, preferences, and intent. Whether you're looking for "a quiet place to work" or "the fastest route avoiding tolls," Mapier interprets your needs and delivers the best solution.
            </p>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">AI-Powered Intent Recognition</h4>
                  <p className="text-gray-600 text-sm">Understands complex, conversational navigation requests using advanced LLM technology</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Learns from your preferences, habits, and history to provide tailored recommendations</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Natural voice commands for hands-free, safe navigation especially while driving</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <p className="text-gray-600 text-sm">User-generated POI data, reviews, and photos for richer, more accurate map information</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200">
              ...
              <p className="text-gray-600 text-sm">Native iOS and Android applications with full feature set</p>
            </div>
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200">
              ...
              <p className="text-gray-600 text-sm">Comprehensive POI database with real-time updates</p>
            </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-gray-600 text-sm">Clean, modern design that's easy to use and visually appealing</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Fast & Accurate</h4>
              <p className="text-gray-600 text-sm">Quick response times with precise location data and route calculations</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Always Learning</h4>
              <p className="text-gray-600 text-sm">The more you use Mapier, the better it understands your preferences</p>
            </div>
          </div>
        </div>
      </div>
