    ...
    <section className="py-24 px-6 sm:px-8 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">Data & Insights</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
            ...
            <p className="text-gray-600 text-sm mb-6">
              Global navigation market size (in billions USD)
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={userJourneyData} layout="vertical">
                <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                ...
                />
                <Bar dataKey="users" fill="#8b5cf6" radius={[0, 8, 8, 0]} name="Users (%)" />
              </BarChart>
            </ResponsiveContainer>
            <p className="text-sm text-gray-500 mt-4 text-center">
